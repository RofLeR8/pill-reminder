...
- [ ] Добавить экран редактирования лекарства
- [ ] Реализовать роутинг между страницами
- [ ] Добавить статистику и историю приёмов
- [ ] Интегрировать с реальным backend API
- [ ] Добавить регистрацию и авторизацию
- [ ] Создать реальные иконки для PWA (сейчас placeholders)
